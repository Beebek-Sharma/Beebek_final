...
function Register() {
  ...
  const handleGoogleRegister = () => {
    // Redirect to Google OAuth login endpoint - same as login
    // Google OAuth will handle registration of new users
    window.location.href = `${import.meta.env.VITE_BACKEND_URL || 'http://localhost:8000'}/accounts/google/login/`;
  };
