        ...
        <div className="space-y-8">
              ...
              <div className="bg-violet-700 text-white p-8 md:w-1/3 rounded-xl md:rounded-r-none">
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://www.facebook.com/nishan.phuyal.0" target="_blank" rel="noopener noreferrer" className="text-white hover:text-violet-200">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a href="https://x.com/Sosuke7_Aizen" target="_blank" rel="noopener noreferrer" className="text-white hover:text-violet-200">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                      </svg>
                    </a>
                    <a href="https://www.instagram.com/np._.here" target="_blank" rel="noopener noreferrer" className="text-white hover:text-violet-200">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://www.youtube.com/samyambasnet001" target="_blank" rel="noopener noreferrer" className="text-white hover:text-violet-200">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a href="https://medium.com/@bibehsharma777" target="_blank" rel="noopener noreferrer" className="text-white hover:text-violet-200">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="p-8 md:w-2/3 rounded-xl md:rounded-l-none">
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <button className="mt-6 inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow dark:border-github-darkBorder-sm text-white bg-violet-600 hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500" onClick={() => setSubmitted(false)}>Send Another Message</button>
                  </div>
                ) : (
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow dark:border-github-darkBorder-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500" />
                      </div>
                      <div>
                        <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-github-darkText">Email</label>
                        <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow dark:border-github-darkBorder-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500" />
                      </div>
                      <div>
                        <label htmlFor="subject" className="block text-sm font-medium text-gray-700 dark:text-github-darkText">Subject</label>
                        <input type="text" id="subject" name="subject" value={formData.subject} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow dark:border-github-darkBorder-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500" />
                      </div>
                      <div>
                        <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-github-darkText">Message</label>
                        <textarea id="message" name="message" rows="5" value={formData.message} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow dark:border-github-darkBorder-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500"></textarea>
                      </div>
                      <div>
                        <button type="submit" className="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow dark:border-github-darkBorder-sm text-sm font-medium rounded-md text-white bg-violet-600 hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500">Send Message</button>
                      </div>
                    </form>
                  </>
                )}
          ...
          <section className="p-8 rounded-xl shadow-md bg-white dark:bg-github-darkAccent w-full max-w-none">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2">
                <a href="https://www.google.com/maps/place/Dharan+Clock+Tower/@26.8093935,87.2847551,2239m/data=!3m1!1e3!4m15!1m8!3m7!1s0x39ef419fc7271c1d:0x1d1300367590c002!2sDharan,+Nepal!3b1!8m2!3d26.806497!4d87.2847086!16zL20vMDRud3cz!3m5!1s0x39ef419934314a0f:0x7e972d70469844fa!8m2!3d26.8117069!4d87.2852886!16s%2Fm%2F05c36vb!5m1!1e4?entry=ttu&g_ep=EgoyMDI1MDkwMy4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sky-600 hover:text-sky-800">
