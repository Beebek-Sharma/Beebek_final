        ...
        <div className="space-y-8">
          ...
          <section className="p-8 rounded-xl shadow-md bg-white dark:bg-github-darkAccent w-full max-w-none">
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              <a href="/courses" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow dark:border-github-darkBorder-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Browse Courses</a>
              <a href="/universities" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow dark:border-github-darkBorder-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Explore Universities</a>
              <a href="/contact" className="inline-flex items-center px-4 py-2 border border-gray-300 shadow dark:border-github-darkBorder-sm text-base font-medium rounded-md text-gray-700 dark:text-github-darkText bg-white dark:bg-github-dark hover:bg-gray-50 dark:bg-github-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Contact Us</a>
            </div>
          </section>
        </div>
      </main>
