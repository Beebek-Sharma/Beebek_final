            ...
            >
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                {[
                  ...
                  <motion.div
                    key={index}
                    className="bg-white dark:bg-github-dark overflow-hidden shadow dark:border-github-darkBorder rounded-lg transition-all duration-300 hover:shadow-xl cursor-pointer"
                  ...
                  >
                    <div className="px-4 py-5 sm:p-6">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 dark:text-github-darkText">{item.title}</h3>
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {popularItems.popular_universities.length > 0 ? (
                    popularItems.popular_universities.map((university, index) => (
                      <motion.div
                        key={university.id}
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {popularItems.popular_courses.length > 0 ? (
                    popularItems.popular_courses.map((course, index) => (
                      <motion.div
                        key={course.id}
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
