...
const UserDashboard = () => {
  ...
  // Clerk user fields: user.firstName, user.lastName, user.username, user.primaryEmailAddress?.emailAddress, user.publicMetadata?.role
  return (
          ...
          <div className="border-t border-gray-200">
            <dl>
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  {user?.publicMetadata?.role === 'admin' ? 'Administrator' : 'Student'}
                </dd>
              </div>
            </dl>
          </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-gray-900">Saved Courses</h3>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-gray-900">Compare Courses</h3>
              <p className="mt-1 text-sm text-gray-600">
